output:main.o Lexxer.o parse.o MipsTarget.o x86Target.o optimizations.o builtInFunctions.o
	g++ Lexxer.o x86Target.o main.o parse.o MipsTarget.o optimizations.o builtInFunctions.o -o output
